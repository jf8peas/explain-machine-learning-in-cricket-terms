...
title: "Author - John Fong"
innings: about
chapter: author-john-fong
meta: "5 min · the scorer & platform lead"
lede: "Every world-class broadcast relies on a lead scorer in the box. This course was engineered by John Fong — a Senior Data Product & Platform Lead bridging Computer Science engineering depth, MBA commercial strategy, and AI-native software execution."
commentary: "'The scorer never faces a ball, but nothing counts until it is modelled, verified, and delivered to the executive box.' — John Fong"
codeFile: about/john_fong.py
codeOut: "author profile initialized · 18+ years on the pitch"
code: |
  JOHN_FONG = {
      "credentials": ["B.Sc. (Hons) Computer Science", "MBA"],
      "roles": ["Senior Data Product Manager", "Platform Lead", "Senior Data Analyst"],
      "track_record": "Scale from multi-hundred-million to $1B+ tech enterprises",
      "toolkit": ["Python", "Spark SQL", "Databricks RAG", "Claude Code / AI Agents", "Astro / Tailwind"],
      "contact": "https://www.linkedin.com/in/john-fong-04b7a120/",
  }

  print("author registered · ready for the next fixture")
stats:
  - { k: "Experience", v: "18+ yrs", s: "global ICT & SaaS" }
  - { k: "Track Record", v: "15% YoY", s: "regional revenue lift" }
  - { k: "AI Speed", v: "2wks → 1day", s: "workflow acceleration" }
  - { k: "Connect", v: "LinkedIn", s: "open for connection" }
---
...
* **AI-Assisted Engineering:** Pioneering serverless, AI-driven development workflows (using Claude Code, Cursor, local agent tools, and GitHub Spec Kit) to cut platform asset delivery times from weeks down to single days.

---

## 3. Career Highs & Key Fixtures

* **Intuit (Senior Staff Data Product & Platform Lead):** Led regional APAC data platform strategy, automating executive business reviews (slashing manual effort by 92%) and delivering AI-enabled scoring pipelines that drove 15% YoY revenue growth.
* **eBay (Senior Product Manager - Search, Experiments & Data):** Owned search relevance, metadata schemas, and regional A/B experimentation engines that lifted transaction velocity and optimized monetization ad placements.
