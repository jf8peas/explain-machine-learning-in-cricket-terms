...
![A horizontal box plot titled "The Freak Innings" showing a season of ordinary batting scores clustered between roughly 2 and 78 runs, with the box, median line, and whiskers all sitting in that range. A single point at 180 runs, labelled "180 not out", sits far to the right of the upper whisker, marked in orange to distinguish it from the ordinary blue scores.](/images/outlier-boxplot.png)
...
![A scatter plot titled "Same Freak Innings, a Different Yardstick" plotting each score's z-score against its runs value. Ordinary scores between 2 and 78 runs sit in a tight band between roughly z = -1 and z = 2. Dashed horizontal lines mark z = +3 and z = -3. A single point at 180 runs sits far above the z = +3 line, labelled "180 not out, z = 5.3" and marked in orange.](/images/outlier-zscore.png)
